...
$sql_image = "SELECT * FROM anh";
$result_image = $conn->query($sql_image);
while($result_image->fetch_assoc()) {
    $anh=$result_image;
}
...
<body>
    <div class="container mt-4">
        ...
        <div class="mt-4">
            <h3>Ảnh Phòng</h3>
            <a href="xem.php?id=<?php echo $result_image['id']; ?>">
                    <img src="<?php echo $result_image['image']; ?>" alt="sample picture" width="100px" height="100px">
                    <p><?php echo $result_image['name']; ?></p>
            </a>
        </div>
